...
import { Clock, CheckCircle, XCircle, Search, User } from 'lucide-react';
...
const IncomingProposals: React.FC = () => {
  ...
  const filteredProposals = proposals.filter(proposal => {
    ...
    const matchesSearch = proposal.matchmakerName.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-serif font-bold text-neutral-800">Match Proposals</h1>
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-neutral-500">
                        Proposed by {proposal.matchmakerName}
                      </p>
                    </div>
                  </div>
                ...
                <div className="text-sm text-neutral-500">
                  Received on {new Date(proposal.createdAt).toLocaleDateString()}
                </div>
              </div>
              <div className="flex items-center gap-2">
